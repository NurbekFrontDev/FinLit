...
const UI: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    'charity.goalName': 'На что копим (напр. помощь семье)',
    ...
    'charity.smallHint': 'Помощь по чуть-чуть. Пополняй и трать через «Расходы»: категория «Благотворительность», подкатегория «Маленькие пожертвования».',
  ...
  en: {
    ...
    'charity.goalName': 'What for (e.g. help family)',
    'charity.goalAmount': 'Goal amount',
    'charity.noGoal': 'No major goal yet. Tap “Set a major goal” to start saving for a big donation.',
    'charity.smallHint': 'Helping bit by bit. Top up and spend via “Expenses”: “Charity” category, “Small donations” subcategory.',
