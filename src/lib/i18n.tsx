...
const UI: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    'ov.startHint': 'Стоимость портфеля на начало месяца. Подставляется с конца прошлого месяца, можно изменить.',
    'ov.startCol': 'Начало',
    ...
    'ov.depositAutoHint': 'Подставлено по твоим покупкам монет за месяц. Можно изменить вручную.',
  ...
  en: {
    ...
    'ov.startHint': 'Portfolio value at the start of the month. Prefilled from last month end, you can change it.',
    'ov.startCol': 'Start',
    ...
    'ov.depositAutoHint': 'Prefilled from your coin purchases this month. You can change it.',
