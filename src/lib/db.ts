...
// Помогают примерно понять, что куда класть: гигиена/быт -- Обязательные, гаджеты/хобби -- Цели и хотелки и т.д.
export const WISH_SUBCATEGORY_PRESETS: Record<string, string[]> = {
  'Обязательные': ['Гигиена', 'Бытовая химия', 'Продукты', 'Аптека и здоровье', 'Одежда и обувь', 'Транспорт', 'Дом и быт'],
  'Цели и хотелки': ['Гаджеты', 'Техника', 'Одежда и аксессуары', 'Путешествия', 'Хобби', 'Образование', 'Спорт'],
